...
# =============================================================================
from app.models.careplan.care_plan import (
    CarePlan,
)  # dépend de Patient, Entity, User, PatientEvaluation, Tenant
from app.models.careplan.care_plan_service import (
    CarePlanService,
)  # dépend de CarePlan, ServiceTemplate, User, Tenant
from app.models.catalog.entity_service import (
    EntityService,
)  # dépend de Entity, ServiceTemplate, Tenant
...
# =============================================================================
from app.models.coordination.coordination_entry import (
    CoordinationEntry,
)  # dépend de Patient, User, Tenant
...
from app.models.patient.patient_document import (
    PatientDocument,
)  # dépend de Patient, User, PatientEvaluation, Tenant
from app.models.patient.patient_evaluation import (
    PatientEvaluation,
)  # dépend de Patient, User, Tenant
