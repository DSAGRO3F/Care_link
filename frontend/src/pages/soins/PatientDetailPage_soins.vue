<script setup lang="ts">
  ...
  import type { PatientResponse, PatientEvaluationResponse, PatientVitalsResponse } from '@/types';
  ...
  /** Dernière évaluation disponible (lue depuis la ref chargée via API, pas patient.evaluations qui est vide) */
  ...
  onMounted(async () => {
    ...
    try {
      ...
      // Évaluations toujours chargées (latestEvaluation en dépend sur l'onglet synthèse)
      await loadEvaluations();

      // Charger les données complémentaires de l'onglet actif
