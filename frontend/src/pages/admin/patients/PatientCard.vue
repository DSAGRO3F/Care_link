...
<template>
  <div class="flex items-center gap-3 cursor-pointer" @click="$emit('click', patient)">
    <!-- Avatar initiales -->
    <div
    ...
    <div class="flex-1 min-w-0">
      ...
      <p class="text-sm text-slate-400">{{ formatBirthDate() }} · {{ getAge() }}</p>
    </div>
    ...
    <div class="flex items-center gap-2 shrink-0">
      ...
      <Tag :value="getStatusConfig().label" :severity="getStatusConfig().severity as any" />
    </div>
  </div>
</template>
