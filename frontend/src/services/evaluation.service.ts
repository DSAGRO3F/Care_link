...
const evaluationService = {
  ...
  async startSession(patientId: number, evaluationId: number, deviceInfo: Record<string, any>) {
    return api.post(
      `/patients/${patientId}/evaluations/${evaluationId}/sessions`,
      { device_info: deviceInfo } as StartSessionPayload
    )
  },
  ...
  async endSession(
    ...
    return api.patch(
      `/patients/${patientId}/evaluations/${evaluationId}/sessions/${sessionId}`,
      data
    )
  },
  ...
  async syncOffline(
    ...
    return api.post(
      `/patients/${patientId}/evaluations/${evaluationId}/sync`,
      {
