 ...
 */
export async function updateTenant(tenantId: number, data: TenantUpdate): Promise<TenantResponse> {
 ...
 * Suspend un tenant
 */
export async function suspendTenant(tenantId: number, reason?: string): Promise<TenantResponse> {
 ...
 */
export async function getCurrentUsage(tenantId: number): Promise<CurrentUsageResponse> {
 ...
 */
export async function listAdminUsers(tenantId: number): Promise<TenantAdminUserResponse[]> {
