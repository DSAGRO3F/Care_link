  ...
  <div class="usager-form">
    ...
    <fieldset class="form-fieldset">
      ...
      <div class="form-grid-2">
        <!-- Nom de famille -->
        <div class="form-group">
          <label for="nomFamille" class="form-label form-label--required">
            Nom de famille
          </label>
          <InputText
            id="nomFamille"
      ...
      <div class="form-grid-2">
        ...
        <div class="form-group">
          <label for="prenomsActeNaissance" class="form-label">
            Prénom(s) acte de naissance
          </label>
          <InputText
      ...
      <div class="form-grid-2">
        ...
        <!-- Situation familiale -->
        <div class="form-group">
          <label for="situationFamiliale" class="form-label">
            Situation familiale
          </label>
          <Dropdown
      ...
      <div class="form-grid-2">
        ...
        <div class="form-group">
          <label for="communeNaissance" class="form-label">
            Commune de naissance
          </label>
          <InputText
            id="communeNaissance"
            ...
            class="w-full"
            placeholder="ex: 75012 Paris 12e"
          />
        </div>

        <!-- Pays de naissance -->
        <div class="form-group">
          <label for="paysNaissance" class="form-label">
            Pays de naissance
          </label>
          <InputText
            id="paysNaissance"
      ...
      <div class="form-grid-2">
        <div class="form-group">
          <label for="nir" class="form-label">
        ...
        <!-- INS (si disponible) -->
        <div class="form-group">
          <label for="ins" class="form-label">
    ...
    <fieldset class="form-fieldset">
      ...
      <div class="form-group">
        <label for="adresseCommentaire" class="form-label">
          Complément d'adresse / accès
        </label>
        <Textarea
    ...
    <div v-if="prefillApplied" class="form-prefill-banner">
      ...
      <span>
        Les champs ont été pré-remplis depuis la fiche patient.
        Vous pouvez les compléter ou les modifier.
      </span>
    </div>
  </div>
</template>
...
import { UserCircle, MapPin, Phone, Info } from 'lucide-vue-next'
...
function syncDateFromFields() {
  ...
  if (d && m && y && birthYear.value.length === 4 &&
...
function loadFromBrouillon() {
  ...
  if (d.communeNaissance) form.communeNaissance = d.communeNaissance
...
function serializeFormData(): Record<string, any> {
  return {
    // État civil
    ...
    communeNaissance: form.communeNaissance || null,
 ...
 * convention #3 (FRONTEND_CONVENTIONS.md).
 */
.usager-form {
  @apply space-y-6;
}
