  ...
  <div class="entity-selector">
    ...
    <div v-else class="space-y-1 max-h-72 overflow-y-auto rounded-xl border border-slate-200 p-2">
      ...
      >
        ...
        <i
          v-if="depth > 0"
          class="pi pi-minus text-slate-300 text-xs"
        ></i>
        ...
        <div class="flex-1 min-w-0">
          <p class="text-sm text-slate-700 truncate" :class="depth === 0 ? 'font-medium' : ''">
            {{ entity.name }}
          </p>
        ...
        <i
          v-if="modelValue === entity.id"
          class="pi pi-check-circle text-blue-500 shrink-0"
        ></i>
      </button>
    </div>
  </div>
